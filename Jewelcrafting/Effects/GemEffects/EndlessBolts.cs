...
public static class EndlessBolts
{
	static EndlessBolts()
	{
		EffectDef.ConfigTypes.Add(Effect.Endlessbolts, typeof(Config));
	}
	...
	private static class ReduceAmmoUsage
	{
		...
		{
			if (__instance.m_character is Player player && Random.value < player.GetEffect(Effect.Endlessbolts) / 100f)
			{
